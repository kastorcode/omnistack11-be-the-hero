...
import { View, FlatList, Image, Linking, Text, TouchableOpacity } from 'react-native';
...
function Detail() {
	...
	const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" com o valor de {<Text style={style.incidentValue} />{Intl.NumberFormat('pt-BR', { style:'currency', currency:'BRL' }).format(incident.value)}.`;
